  ...
  return (
    <header className={`fixed top-0 inset-x-0 z-50 transition-all duration-300 ${scrolled ? 'glass py-3' : 'py-5 bg-transparent'}`}>
      <div className="mx-auto max-w-7xl px-6 flex items-center justify-between">
        <a href="#home" className="font-display text-lg font-bold tracking-tight"><span className="text-gradient">Portfolio</span></a>
        ...
        <button className="glass rounded-full px-4 py-2 text-xs font-medium hover:bg-white/10 transition">Admin</button>
      </div>
    </header>
  )
}
